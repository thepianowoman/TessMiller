...
export var wallSound = new soundFile("MetalBacking.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("MetalBacking.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("MetalBacking.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("MetalBacking.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = -20; //turn down volume

export var adventureMusic = new soundFile("MetalBacking.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = -16;

export var villageMusic = new soundFile("MetalBacking.mp3");
